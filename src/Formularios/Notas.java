...
public class Notas extends javax.swing.JInternalFrame {
   int id_lote;
    ...
    public void terminar(){
         ...
         if(INF_NOTAS.getText().compareTo("")!=0 && id_lote > 0 && INF_CANTIDAD.getText().compareTo("")!=0 ){
            
            
        CTrabajos m = new CTrabajos();
        try {
           m.setId_lote(id_lote);
           m.setNotas(INF_NOTAS.getText());
           m.setCantidadporlote(Integer.parseInt(INF_CANTIDAD.getText()));
           BDTrabajos.EditarNota(m);
           JOptionPane.showMessageDialog(null, "Lote Modificada");
           limpiar();
          // LimpirTablaPro();
           ListarTrabajos();
        ...
        }else{JOptionPane.showMessageDialog(null, "Las Notas No pueden Estar Vacias");
        }
    }
    ...
    private void TrabajosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TrabajosMouseClicked
        ...
        try {
            CTrabajos c = BDTrabajos.buscarTrabajoEditar(Integer.parseInt(String.valueOf(Trabajos.getModel().getValueAt(Trabajos.getSelectedRow(),0))));
    ...
    private void ListarTrabajos(){
        ArrayList<CTrabajos> result = BD.BDTrabajos.ListarTrabajosNotas(PN.getText(),JOB.getText());
